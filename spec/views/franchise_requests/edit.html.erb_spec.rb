...
RSpec.describe "franchise_requests/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit franchise_request form" do
    render

    assert_select "form[action=?][method=?]", franchise_request_path(@franchise_request), "post" do
