...
ActiveRecord::Schema.define(version: 20151228105139) do
  ...
  add_index "bonus_users", ["bonus_id", "user_id"], name: "bonus_users_index", unique: true, using: :btree
  ...
  create_table "franchise_requests", force: :cascade do |t|
    t.string   "fio"
